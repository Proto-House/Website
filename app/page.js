    ...
    <>
      <Section className="pt-20 md:pt-28">
        <div className="max-w-3xl space-y-7">
          <p className="inline-flex rounded-full border border-blue-200 bg-blue-50 px-4 py-1 text-sm font-medium text-blue-700">
            Built for robotics teams, students, and hobbyist
          </p>
          ...
          <p className="max-w-2xl text-lg leading-relaxed text-zinc-600 md:text-xl">
            Proto-House provides affordable prototyping materials and kits for robotics teams and hobbyists. We focus on iteration, speed, and accessibility so teams can test ideas faster, learn from real hardware, and build confidence through hands-on engineering. Aiming to provide students with an interactive learning experience in all fields of engineering by providing schools with cost effective and student friendly products.
          </p>
      ...
      <Section id="why" className="border-t border-zinc-200">
        ...
        <ul className="mt-7 grid gap-4 text-zinc-700 md:grid-cols-3">
          ...
          <li className="rounded-lg border border-zinc-200 p-5">Affordable compared to traditional machining for hobbyist</li>
        </ul>
      </Section>
    </>
  );
